...
const page = () => {
  return (
    <Container>
      ...
      <div>
        En Argentina, el deporte ocupa un lugar central en la vida comunitaria,
        y los clubes constituyen una de las instituciones sociales más
        representativas. <br />
        <br />
        ...
        que transmite valores, fortalece vínculos y genera identidad colectiva.{" "}
        <br />
        <br />
        ...
        consolidar estos valores, ofreciendo un marco competitivo que, más allá
        de los resultados deportivos, brinde a cada jugador, capitán y equipo
        una experiencia enriquecedora, sustentada en{" "}
        <span className="text-primary">
      ...
      <p>
        ...
        <span className="text-primary">
          Casi 200 equipos en competencia, más de 60 clubes participantes y más
          de 3000 jugadores activos.
        </span>
        <br /> <br />
        ...
        , integrando clubes, barrios privados, countries y complejos deportivos
        que comparten la pasión por el tenis y el espíritu de equipo.
      </p>
