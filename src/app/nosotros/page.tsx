    ...
    <Container>
      ...
      <div className="flex flex-col gap-y-4 mt-2">
        ...
        <p>
          ...
          sino también vivir una experiencia compartida que combina deporte,
          compromiso y sentido de comunidad.
        </p>
        <p>
          ...
          equipo una experiencia enriquecedora, sustentada en la pasión, el
          respeto y la pertenencia.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-y-4">
        <p>
          ...
          <span className="text-primary">200 equipos y 20 categorías</span> que
          abarcan distintos niveles de juego en damas, caballeros y mixtos.
        </p>
        <p>
          En esta competencia vas a compartir una experiencia única junto a tu
          grupo de amigos: representando a tu club o barrio , jugando en tus
          propias canchas y descrubriendo nuevas sedes y rivales cada semana.
        </p>
        <p>
          Todos los resultados, tablas de posiciones, estadísticas y rankings se
          actualizan online y de forma permanente, brindando una experiencia{" "}
          <span className="text-primary">
        ...
        <p>
          Vas a poder recibir premios, reconocimientos y beneficios exclusivos.
