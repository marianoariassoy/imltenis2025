...
const page = async () => {
  ...
  return (
    <Container>
      ...
      <Info text="Los cuatro (4) clubes mejor ubicados competirán en las finales de interclubes al cierre de la temporada 2026." />
      ...
      <div className="p-6 rounded-2xl bg-black/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center">
          <div>
            ...
            <span className="font-semibold">Caza y Pesca</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="font-semibold">San Miguel</span>
          </div>
        </div>
      </div>
    </Container>
